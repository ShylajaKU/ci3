...
*/
$autoload['libraries'] = array('database','session' , 'form_validation','session','calendar','table','email','ftp');
...
*/
$autoload['helper'] = array('url' , 'file' , 'form' , 'text' , 'path' , 'html' , 'string' , 'date');
